...
public class FrmNuevoTecnico extends javax.swing.JInternalFrame {

    private GestorVistaAdmTecnico gestor = new GestorVistaAdmTecnico();
    private GestorVistaNuevoTecnico gestorNuevoTecnico = new GestorVistaNuevoTecnico();
    ...
    public FrmNuevoTecnico() {
        initComponents();
        gestorNuevoTecnico.cargarComboProv();
        gestorNuevoTecnico.cargarComboLocalidad();
        gestor.buscarTecnico();
        this.setLocation(500, 30);

    }

    public FrmNuevoTecnico(int modo) {
        initComponents();
        gestor.buscarTecnico();
        gestorNuevoTecnico.cargarComboProv();
        gestorNuevoTecnico.cargarComboLocalidad();
    ...
    public GestorVistaAdmTecnico getGestor() {
        return gestor;
    }

    public void setGestor(GestorVistaAdmTecnico gestor) {
        this.gestor = gestor;
    }

    public GestorVistaNuevoTecnico getGestorNuevoTecnico() {
        return gestorNuevoTecnico;
    }

    public void setGestorNuevoTecnico(GestorVistaNuevoTecnico gestorNuevoTecnico) {
        this.gestorNuevoTecnico = gestorNuevoTecnico;
    }
...
//////////////////////////////////////////////////////////////////////////////    
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Código de Técnico:");
        ...
        btnB.setToolTipText("Buscar Técnico");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        this.gestorNuevoTecnico.guardarNuevo();
    ...
    private void btnBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBActionPerformed
        this.getGestorTecnico().buscarEditar();
